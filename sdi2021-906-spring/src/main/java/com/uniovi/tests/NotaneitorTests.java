...
public class NotaneitorTests {
	...
	public void PR06() {
		...
		// COmprobamos el error de DNI demasiado corto.
		PO_RegisterView.checkKey(driver, "Error.signup.dni.length", PO_Properties.getSPANISH());
		// Rellenamos el formulario
		PO_RegisterView.fillForm(driver, "11111A", "Josefo", "Perez", "77778", "77777");
		// COmprobamos el error de DNI demasiado corto.
	...
	// PR10. Loguearse sin exito desde el ROl de alumno, 99999990A, 123456
	@Test
	public void PR10() {
		// Vamos al formulario de logueo.
		PO_HomeView.clickOption(driver, "login", "class", "btn btn-primary");
	...
	// PR10. Identificación válida y desconexión con usuario de ROL usuario,
	// 99999990A, 123456
	@Test
	public void PR11() {
		// Vamos al formulario de logueo.
